...
formation_coll = Consensus([[8,5], [7.8,8], [9.9,7], [9.0, 5.3]], scaler_meter2px, ctr="exp")
formation_coll.create_formation([
    [[1,1],[2,sqrt(2)],[3,1]],
    [[0,1],[2,1],[3,sqrt(2)]],
    [[0,sqrt(2)],[1,1],[3,1]],
    [[0,1],[1,sqrt(2)],[2,1]]
